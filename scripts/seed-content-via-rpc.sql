-- Run once in Supabase SQL Editor. Creates a function the seed script can call via RPC.
CREATE OR REPLACE FUNCTION public.seed_beckford_site_content()
RETURNS void
LANGUAGE plpgsql
SECURITY DEFINER
...
END;
$$;
GRANT EXECUTE ON FUNCTION public.seed_beckford_site_content() TO service_role;
GRANT EXECUTE ON FUNCTION public.seed_beckford_site_content() TO anon;
